...
@section('content')
    <div class="home-mv">
        <img src="{{ asset('img/10-img.png') }}" alt="" class="octoverse">
        <div class="txt-box">
            ...
            <p class="myanmar-text">ယခု Website သည် Octoverse Payment Gateway ၏ Sample Payment Flow အား Testing
                ပြုလုပ်နိုင်စေရန် ရည်ရွယ်သည့် Demo Website ဖြစ်ပါသည်။ ယခု Website မှ Items များကို ဝယ်ယူပါက အဆိုပါပစ္စည်းအား
                အမှန်တကယ်ရရှိမည် မဟုတ်သော်လည်း လူကြီးမင်း၏ Bank Account မှ အဆိုပါ ပစ္စည်းတန်ဖိုး၏ ကျသင့်ငွေ
                ဖြတ်သွားမည်ဖြစ်ပါကြောင်း အသိပေးကြေညာ အပ်ပါသည်။ </p>
